# -*- coding: utf-8 -*-
#
# dev.plone.org documentation build configuration file, created by
...
htmlhelp_basename = 'devploneorgdoc'
...
latex_documents = [
  (master_doc, 'devploneorg.tex', u'dev.plone.org Documentation',
...
man_pages = [
    (master_doc, 'devploneorg', u'dev.plone.org Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'devploneorg', u'dev.plone.org Documentation',
   author, 'devploneorg', 'One line description of project.',
   'Miscellaneous'),
]
